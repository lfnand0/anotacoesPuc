...
class Hash {
    ...
    public int h(String item) {
        int aux = 0;
        for (int i = 0; i < item.length(); i++) {
            aux += (int) item.charAt(i);
        }

        return aux % m;
    }

    public int reh(String item) {
        int aux = 0;
        for (int i = 0; i < item.length(); i++) {
            aux += (int) item.charAt(i);
        }
    ...
    public boolean pesquisar(String elemento) {
        ...
        if (tabela[pos] != NULO) {
            ...
            if (tabela[pos].getNome().equals(elemento) || tabela[pos2].getNome().equals(elemento)){
                retorno = true;
            }
        }
...
class TP04Q07 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numEntrada; i++) {
            System.out.println(hashTable.pesquisar(entrada[i]) ? " SIM" : " NAO");
        }
