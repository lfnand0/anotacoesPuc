...
class Lista {
    ...
    public String pesquisaSequencial(Object nome) {
        // Realiza a pesquisa sequencial do valor "nome" na lista
        String retorno = "NÃO";
        for (int i = 0; i < n; i++, compareCounter++) {
            compareCounter++;
            if ((((Serie) array[i]).getNome().equals(nome))) {
                retorno = "SIM";
                break;
            }
        }
...
class TP02Q03 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numEntrada; i++) {
            ...
            MyIO.println(lista.pesquisaSequencial(entrada[i]));
