...
class Lista {
    ...
    /**
     * Compara duas séries de acordo com o atributo idioma, e caso
     * eles sejam iguais, compara de acordo com o atributo nome
     */
    public int comparar(Serie a, Serie b) {
        String str1 = a.getIdioma(), str2 = b.getIdioma();
    ...
    /**
     * Ordena a lista de acordo com o atributo idioma utilizando o algoritmo
