...
class Lista {
    ...
    /**
     * Compara duas séries de acordo com o atributo numeroDeTemporadas, e caso eles sejam
     * iguais, compara de acordo com o atributo nome
     */
    public int comparar(Serie a, Serie b) {
        int num1 = a.getNumeroDeTemporadas(), num2 = b.getNumeroDeTemporadas();
    ...
    public void matricula(long time) { // criação do arq log
        ...
        try {
            File myObj = new File("matrícula_bolha.txt");
        ...
        try {
            FileWriter myWriter = new FileWriter("matrícula_bolha.txt");
