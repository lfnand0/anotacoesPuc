...
int armazenado(int v[], int n, int x)
{
  if (n == 0)
  {
    return 0;
...
int main()
{
  ...
  printf("Digite o valor que você deseja checar se está ou não armazenado no vetor: ");
  scanf("%d", &x);
  if (armazenado(A, n, x) == 1)
  {
